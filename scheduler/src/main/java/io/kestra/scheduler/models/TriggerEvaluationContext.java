...
/**
 * Represents the triggerContext required to evaluate a trigger is ready to be scheduled.
 *
 ...
 * @param conditionContext the condition evaluation triggerContext used for trigger conditions
 */
