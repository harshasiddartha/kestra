CREATE TABLE IF NOT EXISTS namespace_file_metadata (
    ...
    "directory" BOOL NOT NULL GENERATED ALWAYS AS (CAST(value ->> 'directory' AS BOOL)) STORED,
...
CREATE INDEX IF NOT EXISTS ix_directory_last_deleted_tenant_namespace_path ON kv_metadata ("directory", "last", "deleted", "tenant_id", "namespace", "path");
